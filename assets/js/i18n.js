...
(function () {
  ...
  var D = {
    ...
    "이 되는 곳": ["", ""],
    "I.D. Toys는 태국 라차부리에서 봉제인형을 전문 생산하는 제조사입니다.": ["I.D. Toys is a plush toy manufacturer based in Ratchaburi, Thailand.", "I.D. Toys คือโรงงานผลิตตุ๊กตาผ้าโดยเฉพาะ ตั้งอยู่ที่ราชบุรี ประเทศไทย"],
    ...
    /* ===== trust ===== */
    "봉제인형 단일 품목 전문 공장": ["A factory dedicated to plush toys only", "โรงงานที่เชี่ยวชาญเฉพาะตุ๊กตาผ้า"],
    ...
    "보세요": ["", ""],
    "봉제인형 하나만 만들어 온 태국 라차부리의 공장 이야기와 품질·안전 기준을 소개합니다.": ["The story of our Ratchaburi factory and our quality & safety standards.", "เรื่องราวของโรงงานที่ราชบุรี และมาตรฐานคุณภาพความปลอดภัยของเรา"],
    ...
    "태국 라차부리의 I.D. Toys는 원단 재단부터 검수·포장까지 전 공정을 한 지붕 아래에서 처리하는 봉제인형 전문 제조사입니다.": ["I.D. Toys in Ratchaburi handles everything — cutting, sewing, inspection and packing — under one roof.", "I.D. Toys ที่ราชบุรี ดูแลทุกขั้นตอนตั้งแต่ตัดผ้า เย็บ ตรวจสอบ จนถึงบรรจุ ภายใต้หลังคาเดียว"],
    ...
    "ID는": ["ID stands for", "ID แปลว่า"],
    "이름": ["a name", "ชื่อ"],
    "이라는 뜻입니다": ["", ""],
    "공장에서 나온 인형에게는 품번이 있지만, 아이의 품에 안긴 인형에게는 이름이 있습니다. 아이디토이의 모든 인형은 주문이 들어온 뒤에야 바느질을 시작하고, 완성된 뒤에는 여러분이 지어 준 이름을 자수 태그에 새겨 떠납니다.": ["A plush from a factory has a product code; a plush in a child's arms has a name. Every ID TOY is sewn only after your order arrives, and leaves with the name you chose embroidered on its tag.", "ตุ๊กตาจากโรงงานมีรหัสสินค้า แต่ตุ๊กตาในอ้อมกอดเด็กมีชื่อ ID TOY ทุกตัวเริ่มเย็บหลังได้รับออเดอร์ และออกเดินทางพร้อมชื่อที่คุณตั้ง ปักบนป้าย"],
    "모든 친구는": ["Every friend is", "เพื่อนทุกตัว"],
    "예약 주문": ["made to order", "ผลิตตามสั่งจอง"],
    "으로만, 주문받은 만큼만 만듭니다. 세상에 같은 얼굴이 하나도 없듯, 아이디토이의 친구들도 표정이 조금씩 다릅니다. 그 미세한 다름이, 오직 한 사람만의 친구가 되는 시작이라고 믿어요.": [" only — we make just as many as are ordered. Like faces in the world, each friend's expression differs slightly. We believe that tiny difference is where being someone's one-and-only begins.", " เท่านั้น — เราผลิตเท่าที่มีคนสั่ง เหมือนใบหน้าคนที่ไม่ซ้ำกัน เพื่อนแต่ละตัวมีสีหน้าต่างกันเล็กน้อย เราเชื่อว่าความต่างเล็ก ๆ นั้นคือจุดเริ่มของการเป็นเพื่อนเพียงหนึ่งเดียว"],
    ...
    "“가장 오래 기억되는 장난감은,": ["“The toy remembered longest", "“ของเล่นที่ถูกจดจำนานที่สุด"],
    "이름이 있던 장난감이었습니다.”": ["was the one that had a name.”", "คือของเล่นที่มีชื่อ”"],
