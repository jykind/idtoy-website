...
(function () {
  ...
  var D = {
    ...
    "OEM 주문 제작, ODM 기획 개발, 기성 몸판 커스텀 — 세 가지 제작 방식과 6단계 공정을 안내합니다.": ["OEM builds, ODM development and stock customs — three ways to make, in six steps.", "OEM, ODM และ Stock Custom — สามวิธีการผลิตใน 6 ขั้นตอน"],
    ...
    "기성 몸판 커스텀": ["Stock Custom", "สต็อกคัสตอม"],
    ...
    "기성 몸판 커스텀 — 로고·컬러만 바꿔서": ["Stock Custom — swap only logo & colors", "Stock Custom — เปลี่ยนแค่โลโก้และสี"],
    ...
    "신규 도면 제작(OEM·ODM)은 500개, 기존 몸판을 활용하는 기성 몸판 커스텀은 1,000개부터 가능합니다(협의 가능). 사이즈·사양에 따라 조정될 수 있으니 우선 문의해 주세요.": ["New builds (OEM/ODM) start at 500 pcs; stock customs using our existing bodies start at 1,000 (negotiable). It varies by size and spec, so please ask first.", "งานผลิตใหม่ (OEM/ODM) เริ่มที่ 500 ชิ้น สต็อกคัสตอมที่ใช้โครงเดิมเริ่มที่ 1,000 ชิ้น (ต่อรองได้) ขึ้นกับขนาดและสเปก สอบถามก่อนได้"],
    "샘플 비용과 기간은 어떻게 되나요?": ["What about sample cost and timing?", "ค่าตัวอย่างและระยะเวลา?"],
    "신규 도면 샘플은 2–3주가 소요되며, 샘플비는 양산 발주 시 전액 공제됩니다. 기성 몸판 커스텀 샘플은 1–2주로 더 빠릅니다.": ["New-build samples take 2–3 weeks; the sample fee is fully credited on production orders. Stock custom samples are faster at 1–2 weeks.", "ตัวอย่างงานใหม่ใช้เวลา 2–3 สัปดาห์ ค่าตัวอย่างหักคืนเต็มเมื่อสั่งผลิต สต็อกคัสตอมเร็วกว่าที่ 1–2 สัปดาห์"],
    ...
    "여덟 가지 몸판은 기성 몸판 커스텀의 베이스가 됩니다. 로고 자수·컬러·의상만 바꾸면 귀사의 캐릭터로 다시 태어나요. 모두 자수 마감이라 영·유아 상품에도 안전합니다.": ["These eight bodies are the base for Stock Custom. Swap the logo embroidery, colors and outfit, and they're reborn as your brand's character. All embroidered finishes — safe even for infant products.", "โครงทั้งแปดคือฐานของ Stock Custom เปลี่ยนโลโก้ปัก สี และชุด ก็กลายเป็นคาแรกเตอร์ของแบรนด์คุณ ปักทั้งหมด ปลอดภัยแม้กับสินค้าทารก"],
    ...
    "기성 몸판 커스텀으로 가볍게 시작해 보세요. 로고 자수 하나만 바꿔도 우리 브랜드의 인형이 됩니다.": ["Start light with Stock Custom. Even swapping a single logo embroidery makes it your brand's plush.", "เริ่มแบบเบา ๆ ด้วย Stock Custom แค่เปลี่ยนโลโก้ปักอันเดียว ก็เป็นตุ๊กตาของแบรนด์คุณแล้ว"],
