...
(function () {
  ...
  var D = {
    ...
    "OEM 주문 제작, ODM 기획 개발, 컬래버 에디션 — 세 가지 제작 방식과 6단계 공정을 안내합니다.": ["OEM builds, ODM development and collab editions — three ways to make, in six steps.", "OEM, ODM และ Collab Edition — สามวิธีการผลิตใน 6 ขั้นตอน"],
    ...
    /* ===== consumer band ===== */
    "우리가 만든 것을,": ["See for yourself", "มาดูด้วยตาคุณเอง"],
    "직접 보여드립니다": ["what we make", "ว่าเราผลิตอะไร"],
    "ID TOY 컬렉션은 자사 스톡 라인으로 꾸린 쇼케이스입니다. 견적을 내기 전에 우리 공장의 실물 퀄리티와 감각을 먼저 구경해 보세요 — 귀사의 프로젝트도 같은 라인에서 같은 기준으로 만들어집니다.": ["ID TOY Collection is a showcase built from our stock line. Before requesting a quote, browse our factory's real-world quality and sensibility — your project is made on the same line, to the same standard.", "ID TOY Collection คือโชว์เคสจากไลน์สต็อกของเรา ก่อนขอใบเสนอราคา มาชมคุณภาพจริงและเซนส์ของโรงงานเรา — โปรเจกต์ของคุณผลิตบนไลน์เดียวกัน มาตรฐานเดียวกัน"],
    "쇼케이스 보러 가기": ["Visit the Showcase", "ชมโชว์เคส"],
    ...
    "최소 주문 500개부터": ["Min. order from 500 pcs", "สั่งขั้นต่ำ 500 ชิ้น"],
    ...
    "컬래버 에디션": ["Collab Edition", "คอลแลบเอดิชัน"],
    "아티스트·브랜드와 함께 한정판을 만듭니다. 자사 몸판 8종을 캔버스 삼아 로고 자수, 컬러, 의상, 넘버링 태그까지 — 수량은 작아도 이야기는 큽니다.": ["Limited editions made together with artists and brands. Our 8 stock bodies become the canvas — logo embroidery, colors, outfits, even numbered tags. Small runs, big stories.", "ลิมิเต็ดอิดิชันที่ทำร่วมกับศิลปินและแบรนด์ โครงตุ๊กตา 8 แบบของเราคือผืนผ้าใบ — โลโก้ปัก สี ชุด จนถึงแท็กรันหมายเลข จำนวนน้อยแต่เรื่องราวยิ่งใหญ่"],
    "아티스트 · 브랜드 컬래버 한정판": ["Limited collabs with artists & brands", "ลิมิเต็ดร่วมกับศิลปินและแบรนด์"],
    "최소 주문 1,000개부터": ["Min. order from 1,000 pcs", "สั่งขั้นต่ำ 1,000 ชิ้น"],
    ...
    "컬래버 에디션 — 자사 몸판으로 한정판": ["Collab Edition — limited run on our stock bodies", "Collab Edition — ลิมิเต็ดจากโครงของเรา"],
    "아직 모르겠어요": ["Not sure yet", "ยังไม่แน่ใจ"],
    "500 – 1,000개": ["500 – 1,000 pcs", "500 – 1,000 ชิ้น"],
    "1,000 – 5,000개": ["1,000 – 5,000 pcs", "1,000 – 5,000 ชิ้น"],
    "5,000 – 10,000개": ["5,000 – 10,000 pcs", "5,000 – 10,000 ชิ้น"],
    "10,000개 이상": ["10,000+ pcs", "มากกว่า 10,000 ชิ้น"],
    ...
    "최소 주문 수량은 얼마인가요?": ["What is the minimum order quantity?", "จำนวนสั่งขั้นต่ำเท่าไหร่?"],
    "신규 도면 제작(OEM·ODM)은 500개, 자사 몸판을 활용하는 컬래버 에디션은 1,000개부터 가능합니다(협의 가능). 사이즈·사양에 따라 조정될 수 있으니 우선 문의해 주세요.": ["New builds (OEM/ODM) start at 500 pcs; collab editions on our stock bodies start at 1,000 (negotiable). It varies by size and spec, so please ask first.", "งานผลิตใหม่ (OEM/ODM) เริ่มที่ 500 ชิ้น คอลแลบเอดิชันจากโครงของเราเริ่มที่ 1,000 ชิ้น (ต่อรองได้) ขึ้นกับขนาดและสเปก สอบถามก่อนได้"],
    "샘플 비용과 기간은 어떻게 되나요?": ["What about sample cost and timing?", "ค่าตัวอย่างและระยะเวลา?"],
    "신규 도면 샘플은 2–3주가 소요되며, 샘플비는 양산 발주 시 전액 공제됩니다. 자사 몸판을 활용하는 컬래버 에디션 샘플은 1–2주로 더 빠릅니다.": ["New-build samples take 2–3 weeks; the sample fee is fully credited on production orders. Collab edition samples on stock bodies are faster at 1–2 weeks.", "ตัวอย่างงานใหม่ใช้เวลา 2–3 สัปดาห์ ค่าตัวอย่างหักคืนเต็มเมื่อสั่งผลิต คอลแลบเอดิชันจากโครงเดิมเร็วกว่าที่ 1–2 สัปดาห์"],
    ...
    "그래서 아이디토이의 모든 인형은 주문이 들어온 뒤에야 바느질을 시작합니다. 장인의 손끝에서 표정이 조금씩 달라지고, 완성된 친구는 저마다의 이름을 자수 태그에 새기고 떠납니다. 이름을 갖는 순간, 인형은 비로소 자신만의 ID를 갖게 되니까요.": ["That's why every ID TOY is sewn only after an order arrives. Expressions shift subtly under the artisan's hand, and each finished friend leaves with its own name embroidered on its tag. Because the moment it has a name, a plush finally gets an ID of its own.", "นั่นคือเหตุผลที่ ID TOY ทุกตัวเริ่มเย็บหลังได้รับออเดอร์ สีหน้าเปลี่ยนไปเล็กน้อยตามมือช่าง และเพื่อนที่เสร็จแล้วออกเดินทางพร้อมชื่อของตัวเองปักบนป้าย เพราะวินาทีที่มีชื่อ ตุ๊กตาก็มี ID ของตัวเองเสียที"],
    ...
    "여덟 가지 몸판은 컬래버 에디션의 캔버스가 됩니다. 로고 자수·컬러·의상만 바꾸면 귀사의 캐릭터로 다시 태어나요. 모두 자수 마감이라 영·유아 상품에도 안전합니다.": ["These eight bodies are the canvas for collab editions. Swap the logo embroidery, colors and outfit, and they're reborn as your brand's character. All embroidered finishes — safe even for infant products.", "โครงทั้งแปดคือผืนผ้าใบของคอลแลบเอดิชัน เปลี่ยนโลโก้ปัก สี และชุด ก็กลายเป็นคาแรกเตอร์ของแบรนด์คุณ ปักทั้งหมด ปลอดภัยแม้กับสินค้าทารก"],
    "이 몸판으로 견적 문의": ["Get a quote with this body", "ขอใบเสนอราคาด้วยโครงนี้"],
    "견적 문의 →": ["Get a quote →", "ขอใบเสนอราคา →"],
    "패키지도 제품의 일부입니다. 속지를 걷어내면 가장 먼저 눈이 마주치도록, 눕는 방향까지 정해서 포장합니다. 웰컴 키트·VIP 기프트 프로젝트라면 박스·리본·카드까지 함께 설계해 드립니다.": ["Packaging is part of the product. We position every plush so your eyes meet the moment the tissue lifts. For welcome kits and VIP gifts, we design the box, ribbon and card together.", "แพ็กเกจก็คือส่วนหนึ่งของสินค้า เราจัดวางให้สบตาทันทีที่เปิดกระดาษ สำหรับเวลคัมคิทและของขวัญ VIP เราออกแบบกล่อง ริบบิ้น และการ์ดให้ครบ"],
    "컬래버 에디션으로 가볍게 시작해 보세요. 로고 자수 하나만 바꿔도 우리 브랜드의 인형이 됩니다.": ["Start light with a collab edition. Even swapping a single logo embroidery makes it your brand's plush.", "เริ่มแบบเบา ๆ ด้วยคอลแลบเอดิชัน แค่เปลี่ยนโลโก้ปักอันเดียว ก็เป็นตุ๊กตาของแบรนด์คุณแล้ว"],
    "견적 문의하러 가기": ["Go to Quote Request", "ไปหน้าขอใบเสนอราคา"],
    ...
    "Packaging — 선물이 되는 순간": ["Packaging — The Moment It Becomes a Gift", "Packaging — วินาทีที่กลายเป็นของขวัญ"],
