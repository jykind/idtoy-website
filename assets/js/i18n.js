...
(function () {
  ...
  var D = {
    ...
    /* founders lookbook marquee */
    "옷은 매일 바뀌어도,": ["The outfits change daily —", "ชุดเปลี่ยนทุกวัน —"],
    "손에는 늘 인형": ["the plush never leaves their hands", "แต่ตุ๊กตาไม่เคยห่างมือ"],
    "명절에도, 휴가지에서도, 퇴근 후에도 — 두 사람 손에는 언제나 인형이 들려 있습니다. 46년째 이러고 삽니다.": ["Holidays, vacations, after work — there's always a plush in their hands. 46 years and counting.", "วันหยุด เที่ยวพักผ่อน หลังเลิกงาน — ในมือทั้งสองมีตุ๊กตาเสมอ เป็นแบบนี้มา 46 ปีแล้ว"],
    "월요일의 작업복": ["Monday workwear", "ชุดทำงานวันจันทร์"],
    "명절엔 한복": ["Hanbok for the holidays", "ฮันบกวันเทศกาล"],
    "태국 전통의상": ["Thai traditional dress", "ชุดไทยประจำชาติ"],
    "오늘 저녁은 셰프": ["Chef mode tonight", "คืนนี้เป็นเชฟ"],
    "납기의 히어로": ["Deadline heroes", "ฮีโร่แห่งกำหนดส่ง"],
    "크리스마스 시즌": ["Christmas season", "ซีซันคริสต์มาส"],
    "퇴근 후에도 인형": ["Plush even after hours", "เลิกงานก็ยังมีตุ๊กตา"],
    "아침 운동": ["Morning workout", "ออกกำลังกายตอนเช้า"],
    "여름 휴가": ["Summer vacation", "พักร้อนฤดูร้อน"],
    "커피 한 잔": ["Coffee break", "พักกาแฟสักแก้ว"],
    "한겨울에도": ["Even in midwinter", "แม้กลางฤดูหนาว"],
    ...
    "스톡 커스텀으로 가볍게 시작해 보세요. 로고 자수 하나만 바꿔도 우리 브랜드의 인형이 됩니다.": ["Start light with Stock Custom. Even swapping a single logo embroidery makes it your brand's plush.", "เริ่มแบบเบา ๆ ด้วย Stock Custom แค่เปลี่ยนโลโก้ปักอันเดียว ก็เป็นตุ๊กตาของแบรนด์คุณแล้ว"],
