...
(function () {
  ...
  var D = {
    ...
    "이 되는 곳": ["", ""],
    "I.D. Toys는 태국 라차부리에서 50년째 봉제인형만 만들어 온 제조사입니다.": ["I.D. Toys has been making plush toys — and only plush toys — in Ratchaburi, Thailand for 50 years.", "I.D. Toys ผลิตตุ๊กตาผ้า และเฉพาะตุ๊กตาผ้า ที่ราชบุรี ประเทศไทย มานานกว่า 50 ปี"],
    ...
    /* ===== trust ===== */
    "반세기 동안 인형 하나만 만들어 온 공장": ["Half a century of making plush toys, and nothing else", "ครึ่งศตวรรษที่ผลิตแต่ตุ๊กตาเท่านั้น"],
    ...
    "보세요": ["", ""],
    "50년 동안 봉제인형만 만들어 온 태국 라차부리 공장의 이야기와 품질·안전 기준을 소개합니다.": ["Fifty years of making only plush in Ratchaburi — our story and our quality & safety standards.", "เรื่องราว 50 ปีของโรงงานราชบุรีที่ผลิตแต่ตุ๊กตา และมาตรฐานคุณภาพความปลอดภัย"],
    ...
    "태국 라차부리의 I.D. Toys는 50년 동안 원단 재단부터 검수·포장까지 전 공정을 한 지붕 아래에서 처리해 온 봉제인형 전문 제조사입니다.": ["For 50 years, I.D. Toys in Ratchaburi has handled everything — cutting, sewing, inspection and packing — under one roof.", "ตลอด 50 ปี I.D. Toys ที่ราชบุรีดูแลทุกขั้นตอน ตั้งแต่ตัดผ้า เย็บ ตรวจสอบ จนถึงบรรจุ ภายใต้หลังคาเดียว"],
    "Heritage — 반세기의 바느질": ["Heritage — Half a Century of Stitches", "Heritage — ครึ่งศตวรรษแห่งการเย็บ"],
    "50년 전의 첫 바늘이": ["The first needle from 50 years ago", "เข็มแรกเมื่อ 50 ปีก่อน"],
    "오늘도": ["is still moving", "ยังคงขยับ"],
    "움직이고 있습니다": ["today", "อยู่จนวันนี้"],
    "I.D. Toys의 이야기는 50년 전, 태국 라차부리의 작은 봉제 공방에서 시작되었습니다. 인형 하나를 짓는 데 필요한 것은 좋은 원단과 정직한 바느질뿐이라는 믿음 — 그 믿음 하나로 반세기를 걸어왔습니다.": ["Our story began 50 years ago, in a small sewing workshop in Ratchaburi, Thailand. One belief — that a good plush needs nothing more than honest fabric and honest stitching — has carried us through half a century.", "เรื่องราวของเราเริ่มเมื่อ 50 ปีก่อน ในโรงเย็บเล็ก ๆ ที่ราชบุรี ด้วยความเชื่อเดียว — ตุ๊กตาที่ดีต้องการแค่ผ้าที่ดีและการเย็บที่ซื่อตรง — ความเชื่อนั้นพาเรามาถึงครึ่งศตวรรษ"],
    "시대가 바뀌고 설비가 좋아져도, 인형의 표정만큼은 여전히 사람의 손끝에서 태어납니다. 반세기 전의 원칙이 지금도 작업대 위에 살아 있는 곳 — 그것이 우리 공장입니다.": ["Times change and machines improve, but a plush's expression is still born at human fingertips. A factory where the principles of fifty years ago still live on the workbench — that is who we are.", "ยุคสมัยเปลี่ยน เครื่องจักรดีขึ้น แต่สีหน้าของตุ๊กตายังคงเกิดจากปลายนิ้วมนุษย์ โรงงานที่หลักการเมื่อห้าสิบปีก่อนยังมีชีวิตอยู่บนโต๊ะงาน — นั่นคือเรา"],
    "50년 동안 쌓인 것은 기술만이 아닙니다. 어떤 원단이 아이의 뺨에 닿아도 좋은지, 어떤 봉제선이 수천 번의 포옹을 견디는지 — 시간만이 가르쳐 줄 수 있는 답들이 우리의 도면에 담겨 있습니다.": ["Fifty years built more than skill. Which fabric is gentle enough for a child's cheek, which seam survives thousands of hugs — answers only time can teach, folded into every pattern we cut.", "ห้าสิบปีสร้างมากกว่าทักษะ ผ้าแบบไหนอ่อนโยนพอสำหรับแก้มเด็ก ตะเข็บแบบไหนทนกอดนับพันครั้ง — คำตอบที่มีแต่เวลาสอนได้ อยู่ในทุกแพทเทิร์นของเรา"],
    "“50년 — 한 가지 일을 오래 하면, 그 일이 곧 이름이 됩니다.”": ["“Fifty years — do one thing long enough, and it becomes your name.”", "“ห้าสิบปี — ทำสิ่งเดียวนานพอ สิ่งนั้นก็กลายเป็นชื่อของคุณ”"],
    ...
    "우리는 50년 동안 인형만 만들어 왔습니다. 태국 라차부리의 작은 봉제 공방에서 시작된 바느질은 반세기를 지나 오늘도 이어지고 있어요. 그 긴 시간이 가르쳐 준 것은 단 하나 — 공장을 나설 때는 모두 비슷한 얼굴이지만, 누군가의 품에 안기는 순간 인형은 세상에 하나뿐인 존재가 된다는 사실입니다.": ["We have made plush toys — only plush toys — for 50 years. The stitching that began in a small Ratchaburi workshop continues today, half a century later. And all that time taught us one thing: plush leave the factory wearing similar faces, but the moment one is held, it becomes the only one of its kind in the world.", "เราผลิตตุ๊กตามา 50 ปี การเย็บที่เริ่มในโรงเล็ก ๆ ที่ราชบุรียังคงดำเนินต่อจนวันนี้ เวลาที่ยาวนานสอนเราเพียงเรื่องเดียว — ตุ๊กตาออกจากโรงงานด้วยใบหน้าคล้ายกัน แต่วินาทีที่ถูกกอด มันกลายเป็นหนึ่งเดียวในโลก"],
    ...
    "“50년 동안 수없이 많은 인형을 만들었지만,": ["“We've made countless plush in fifty years,", "“ห้าสิบปีเราผลิตตุ๊กตานับไม่ถ้วน"],
